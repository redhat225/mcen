		...
		<form name="editFormprofiles" ng-submit="update(profile)">
				...
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input required ng-model="profile.user.user_fullname" ng-pattern='/^[^@&()"!_$*ۣ`+=\/;?#]+$/' name="profile_fullname" type="text" class="input is-uppercase">
							<span class="icon is-small is-left">
								<i class="fas fa-user"></i>
							</span>
														<span class="icon is-small is-right" ng-if="editFormprofiles.profile_fullname.$valid">
			...
			<div class="field is-horizontal">
				...
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input  required type="text" ng-model="profile.user.user_job" class="input" name="profile_job">
							<span class="icon is-small is-left">
								<i class="fas fa-briefcase"></i>
							</span>
							<span class="icon is-small is-right" ng-if="editFormprofiles.profile_job.$valid">
								<i class="fa fa-check has-text-success"></i>
							</span>
						</div>
					</div>
			...
			<div class="field is-horizontal">
				...
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input ng-pattern="/^[0-9]{8}$/" type="text" ng-model="profile.user.user_contact" class="input" name="profile_contact">
							<span class="icon is-small is-left">
								<i class="fas fa-phone"></i>
							</span>
							<span class="icon is-small is-right" ng-if="editFormprofiles.profile_contact.$valid">
								<i class="fa fa-check has-text-success"></i>
							</span>
						</div>
					</div>
			...
			<div class="field is-horizontal">
				<div class="field-label">
					<label for="pro_email" class="label">Email Professionnel</label>
				</div>
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input type="email" required ng-model="profile.user.user_pro_email" class="input" name="pro_email">
						<span class="icon is-small is-left">
								<i class="far fa-envelope"></i>
							</span>
							<span class="icon is-small is-right" ng-if="editFormprofiles.pro_email.$valid">
								<i class="fa fa-check has-text-success"></i>
							</span>
						</div>
					</div>
			...
			<div class="field is-horizontal">
				<div class="field-label">
					<label for="user_personal_email" class="label">Email Personnel</label>
				</div>
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input type="email" required ng-model="profile.user.user_personal_email" class="input" name="user_personal_email">
						<span class="icon is-small is-left">
								<i class="far fa-envelope"></i>
							</span>
							<span class="icon is-small is-right" ng-if="editFormprofiles.user_personal_email.$valid">
								<i class="fa fa-check has-text-success"></i>
							</span>
						</div>
					</div>
			...
			<div class="field is-horizontal">
					...
					<div class="field-body">
						<div class="field">
							<div class="control has-icons-left has-icons-right">
								<input required ng-pattern='/^[^@&()"!_$*ۣ`+=\/;?#]+$/' type="text" ng-model="profile.user_account_username" class="input" name="account_username">
								<span class="icon is-small is-left">
